...
/**
 * @ngdoc directive
 * @name angular.module.ng.$compileProvider.directive.ng-selectedTime
 * @restrict A
 *
 * @description
 ...
 * (The presence of them means true and absence means false)
 * This prevents the angular compiler from correctly retrieving the binding expression.
 * To solve this problem, we introduce ng-selectedTime.
 * @example
    <doc:example>
      <doc:source>
...
var inputType = {
   ...
   * @param {string} ng-model Assignable angular expression to data-bind to.
   * @param {string=} name Property name of the form under which the control is published.
   * @param {string=} ng-true-value The value to which the expression should be set when selectedTime.
   * @param {string=} ng-false-value The value to which the expression should be set when not selectedTime.
   * @param {string=} ng-change Angular expression to be executed when input changes due to user
   *    interaction with the input element.
   *
   * @example
 ...
 * represented by the selectedTime option will be bound to the model identified by the `ng-model` attribute
